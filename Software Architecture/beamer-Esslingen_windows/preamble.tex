...
\title[Software Architectures]{Software Architectures}

\subtitle[Design Patterns in Software Engineering]{Design Patterns in Software Engineering}

\author[Prof. Dr. Jörg Friedrich]{Prof. Dr. Jörg Friedrich\inst{1}}% \and
 %Zweiter Autor\inst{1} \and
 %Dritter Autor\inst{2}}

\titlegraphic{\includegraphics[scale=0.5]{figures/HEGoeppingen}}
